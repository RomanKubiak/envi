...
CREATE TABLE IF NOT EXISTS data		(id INTEGER PRIMARY KEY, sourceId INTEGER , valueName TEXT, valueValue REAL, valueUnit INTEGER, valueError INTEGER, timestamp TIMESTAMP);\
"
