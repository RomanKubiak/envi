...
"application/x-director dir dcr dxr cst cct cxt w3d\n"
...
"application/x-xz xz      \n"
"application/x-zmachine z1 z2 z3 z4 z5 z6 z7\n"
...
const char* mime_types = (const char*) temp_binary_data_0;
...
const char* getNamedResource (const char* resourceNameUTF8, int& numBytes) throw()
{
    ...
    switch (hash)
    {
        case 0x95c3e8ae:  numBytes = 28425; return mime_types;
